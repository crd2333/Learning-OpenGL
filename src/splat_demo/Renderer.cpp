...
void ShadersInit() {
    floorShader = new Shaders(  "src/splat_demo/shaders/floorVS.glsl",
                                "src/splat_demo/shaders/floorFS.glsl");
    skyBoxShader = new Shaders( "src/splat_demo/shaders/skyBoxVS.glsl",
                                "src/splat_demo/shaders/skyBoxFS.glsl");
    playerShader = new Shaders("src/splat_demo/shaders/playerVS.glsl",
                                "src/splat_demo/shaders/playerFS.glsl");
    bulletShader = new Shaders("src/splat_demo/shaders/playerVS.glsl",
                                "src/splat_demo/shaders/playerFS.glsl");
    shadowShader = new Shaders("src/splat_demo/shaders/shadowVS.glsl",
                               "src/splat_demo/shaders/shadowFS.glsl");
    //    unsigned int floorTexture;
    //    if(!getTextureID(floorTexture, "../img/floor.jpg")) return 0;
    skyBoxInit("src/splat_demo/resource/texture/skybox");
    floorInit("src/splat_demo/resource/texture/Noise.png");
    shadowInit();
    bulletRenderInit();
    playerRenderInit();
}
