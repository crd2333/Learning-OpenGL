...
void bulletRenderInit() {
    readOBJ("src/splat_demo/resource/obj/bullet.obj", bulletVertices, bulletElement);
...
void playerRenderInit() {
    readOBJ("src/splat_demo/resource/obj/player.obj", playerVertices, playerElement);
